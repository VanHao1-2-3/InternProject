		...
		<div class="row">
			...
			<div id="left-column" class="sidebar col-lg-3 col-md-3 col-sm-3 col-xs-12">
				...
				<div class="block product-categories">
					...
					<div class="block-content">
						<div class="item">
							...
							<a class="category-title" href="product-list.php">Vegetables</a>
							<div class="sub-category collapse" id="vegetables" aria-expanded="true" role="main">
								<div class="item">
									<a href="product-list.php">Tomato</a>
								</div>
								<div class="item">
									<a href="product-list.php">Broccoli</a>
								</div>
								<div class="item">
									<a href="product-list.php">Cabbage</a>
								</div>
								<div class="item">
									<a href="product-list.php">Cucumber</a>
								</div>
							</div>
						</div>
						...
						<div class="item">
							...
							<a class="category-title" href="product-list.php">Fruits</a>
							<div class="sub-category collapse" id="fruits" aria-expanded="true" role="main">
								<div class="item">
									<a href="product-list.php">Orange</a>
								</div>
								<div class="item">
									<a href="product-list.php">Apple</a>
								</div>
								<div class="item">
									<a href="product-list.php">Banana</a>
								</div>
								<div class="item">
									<a href="product-list.php">Strawberry</a>
								</div>
							</div>
						</div>
						...
						<div class="item">
							...
							<a class="category-title" href="product-list.php">Juices</a>
							<div class="sub-category collapse" id="juices" aria-expanded="true" role="main">
								<div class="item">
									<a href="product-list.php">Orange Juices</a>
								</div>
								<div class="item">
									<a href="product-list.php">Tomato Juices</a>
								</div>
								<div class="item">
									<a href="product-list.php">Apple Juices</a>
								</div>
								<div class="item">
									<a href="product-list.php">Peaches Juices</a>
								</div>
							</div>
						</div>

						<div class="item">
							<a class="category-title" href="product-list.php">Tea and Coffee</a>
						</div>

						<div class="item">
							<a class="category-title" href="product-list.php">Jam</a>
						</div>

						<div class="item">
							<a class="category-title" href="product-list.php">SeaFood</a>
						</div>

						<div class="item">
							<a class="category-title" href="product-list.php">Fresh Meats</a>
						</div>
					</div>
				</div>
				...
				<div class="block posts recent-posts">
					...
					<div class="block-content">
						<div class="post-item">
							<a class="post-title" href="blog.php">5 Best Fruits To Make You Fresh And Healthy</a>
							<div class="post-info">
							...
							<div class="post-readmore"><a href="blog.php">Read more</a></div>
						</div>
					...
					<div class="posts-list">
						<div class="post-item">
							...
							<div class="post-description">
								...
								<span class="post-readmore"><a href="blog.php">view more</a></span>
							</div>
						</div>
